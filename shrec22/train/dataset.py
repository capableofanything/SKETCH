"""
Custom Dataset class for SHREC22
"""
import os
import numpy as np
import torch
...
class CustomImageDataset(Dataset):
    """
    Custom dataset for SHREC22 gesture recognition
    ...
    def __init__(self, image_dir, label_path, window_label_path, sequence_path,
        ...
        self.window_labels = np.load(window_label_path)  # (N,16)
        ...
        probs = counts / counts.sum(axis=1, keepdims=True)  # shape (N,17)
    ...
    def __getitem__(self, idx):
        ...
        seq = torch.from_numpy(self.sequence_labels[idx])  # [16,3,26], float32
