"""
Main training script for SHREC19 gesture recognition
"""
import os
import random
...
from config import CONFIG, save_config, WINDOW_SIZE, JOINTS
...
def train_epoch(model, train_loader, criterion_cls, criterion_reg,
    ...
    for images, labels, gesture_start_gt, gesture_end_gt, seq in train_loader_tqdm:
        ...
        # Forward pass
        optimizer.zero_grad()
        outputs_cls, outputs_start, outputs_end = model(images, seq)
...
def plot_metrics(train_accuracies, test_accuracies, train_losses,
    ...
    plot_filename = os.path.join(exp_folder_path,
                                f"shrec19_exp{config['exp_num']}.png")
